"""
Django settings for demoapp1234_dev_137512 project.
...
ROOT_URLCONF = 'demoapp1234_dev_137512.urls'
...
WSGI_APPLICATION = 'demoapp1234_dev_137512.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "demoapp1234 Support <support@demoapp1234-dev-137512.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp1234_dev_137512 API",
    "DESCRIPTION": "API documentation for demoapp1234_dev_137512 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "demoapp1234_dev_137512.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "demoapp1234_dev_137512.storage_backends.AzureStaticStorage"
